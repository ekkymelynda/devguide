									...
									<div class="col-md-12">
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
					                                <select data-placeholder="Pilih kategori" class="select">
					                                    <option value=""></option> 
					                		...
					                		<div class="form-group">
												...
												<div class="col-lg-9">
					                                <select data-placeholder="Pilih status" class="select">
					                                    <option value=""></option>
					                		...
					                		<div class="form-group">
												...
												<div class="col-lg-9">
					                                <select data-placeholder="Pilih bab" class="select">
					                                    <option value=""></option> 
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" placeholder="Contoh: Deskripsi Umum Sistem">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" placeholder="Contoh: localhost/devguide/trunk/post/create">
												</div>
											</div>
