					...
					<!--<li class="dropdown">
						...
						<div class="dropdown-menu dropdown-content">
							...
							<ul class="media-list dropdown-content-body width-300">
								<li class="media">
									<div class="media-left"><img src="<?php  echo base_url(); ?>LTR/assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></div>
									<div class="media-body">
										<a href="#" class="media-heading text-semibold">Posted by Dospel & GanjaParker</a>
					...
					<!--<li class="dropdown">
						...
						<div class="dropdown-menu dropdown-content width-350">
							...
							<ul class="media-list dropdown-content-body">
								<li class="media">
									<div class="media-left">
										<img src="<?php  echo base_url(); ?>LTR/assets/images/placeholder.jpg" class="img-circle img-sm" alt="">
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<!-- Halaman -->
								<li class="navigation-header"><span>Halaman</span> <i class="icon-menu" title="Page kits"></i></li>
								<li>
