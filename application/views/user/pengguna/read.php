				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Tabel</span> - Pengguna</h4>
						</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<a href="<?php echo base_url(); ?>pengguna/create" class="btn btn-primary btn-rounded"><i class="icon-add position-left"></i> Buat</a>
