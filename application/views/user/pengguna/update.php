<!-- Main content -->
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<form class="form-horizontal" action="<?php echo base_url();?>pengguna/ubah/<?php echo $row->USERNAME_PGN;?>" method="post">
						<div class="panel panel-flat">
							<div class="panel-heading">
									...
									<div class="col-md-12">
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" value="<?php echo $row->USERNAME_PGN;?>" name="USERNAME_PGN" readonly="readonly">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<input type="password" class="form-control" name="PASSWORD_PGN">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<input type="email" class="form-control" value="<?php echo $row->EMAIL_PGN;?>" name="EMAIL_PGN">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<input type="telp" class="form-control" value="<?php echo $row->NOTLP_PGN;?>" name="NOTLP_PGN">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" value="<?php echo $row->ALAMAT_PGN;?>" name="ALAMAT_PGN">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" value="<?php echo $row->JABATAN_PGN;?>" name="JABATAN_PGN">
												</div>
											</div>
											<?php }?>
