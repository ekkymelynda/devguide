				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Form</span> - Sub Bab 3</h4>
						</div>
									...
									<div class="col-md-12">
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" disabled="disabled" placeholder="Proses Bisnis untuk Daftar Mahasiswa">
												</div>
											</div>
