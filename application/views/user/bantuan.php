				...
				<div class="content">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="panel-group panel-group-control panel-group-control-right">
								<div class="panel panel-white">
									...
									<div id="question1" class="panel-collapse collapse">
										...
										<div class="panel-footer panel-footer-transparent">
											...
											<ul class="pull-right">
												<li><a href="#"><i class="icon-thumbs-up2 position-left"></i></a> 320</li>
												<li><a href="#"><i class="icon-thumbs-down2 position-left"></i></a> 14</li>
											</ul>
										</div>
									</div>
								</div>
								...
								<div class="panel panel-white">
									...
									<div id="question2" class="panel-collapse collapse">
										...
										<div class="panel-footer panel-footer-transparent">
											...
											<ul class="pull-right">
												<li><a href="#"><i class="icon-thumbs-up2 position-left"></i></a> 278</li>
												<li><a href="#"><i class="icon-thumbs-down2 position-left"></i></a> 25</li>
											</ul>
										</div>
									</div>
								</div>
								...
								<div class="panel panel-white">
									...
									<div id="question4" class="panel-collapse collapse">
										...
										<div class="panel-footer panel-footer-transparent">
											<ul>
												<li class="text-muted">Latest update: May 9, 2015</li>
											</ul>

											<ul class="pull-right">
												<li><a href="#"><i class="icon-thumbs-up2 position-left"></i></a> 583</li>
								...
								<div class="panel panel-white">
									...
									<div id="question5" class="panel-collapse collapse">
										...
										<div class="panel-footer panel-footer-transparent">
											<ul>
												<li class="text-muted">Latest update: May 6, 2015</li>
											</ul>

											<ul class="pull-right">
												<li><a href="#"><i class="icon-thumbs-up2 position-left"></i></a> 642</li>
												<li><a href="#"><i class="icon-thumbs-down2 position-left"></i></a> 26</li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="text-size-small text-uppercase text-semibold text-muted mb-10">Tabel</div>
							<div class="panel-group panel-group-control panel-group-control-right">
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
							...
							<div class="panel-group panel-group-control panel-group-control-right">
								<div class="panel panel-white">
									...
									<div id="question16" class="panel-collapse collapse">
										...
										<div class="panel-footer panel-footer-transparent">
											<ul>
												<li class="text-muted">Latest update: Apr 3, 2015</li>
											</ul>

											<ul class="pull-right">
												<li><a href="#"><i class="icon-thumbs-up2 position-left"></i></a> 479</li>
												<li><a href="#"><i class="icon-thumbs-down2 position-left"></i></a> 17</li>
											</ul>
										</div>
									</div>
								</div>
								...
								<div class="panel panel-white">
									...
									<div id="question17" class="panel-collapse collapse">
										...
										<div class="panel-footer panel-footer-transparent">
											<ul>
												<li class="text-muted">Latest update: Mar 29, 2015</li>
											</ul>

											<ul class="pull-right">
												<li><a href="#"><i class="icon-thumbs-up2 position-left"></i></a> 290</li>
												<li><a href="#"><i class="icon-thumbs-down2 position-left"></i></a> 29</li>
											</ul>
										</div>
									</div>
								...
								<div class="panel panel-white">
									...
									<div id="question18" class="panel-collapse collapse">
										...
										<div class="panel-footer panel-footer-transparent">
											<ul>
												<li class="text-muted">Latest update: Mar 24, 2015</li>
											</ul>

											<ul class="pull-right">
												<li><a href="#"><i class="icon-thumbs-up2 position-left"></i></a> 642</li>
												<li><a href="#"><i class="icon-thumbs-down2 position-left"></i></a> 39</li>
											</ul>
										</div>
									</div>
								</div>
								...
								<div class="panel panel-white">
									...
									<div id="question19" class="panel-collapse collapse">
										...
										<div class="panel-footer panel-footer-transparent">
											<ul>
												<li class="text-muted">Latest update: Mar 17, 2015</li>
											</ul>

											<ul class="pull-right">
												<li><a href="#"><i class="icon-thumbs-up2 position-left"></i></a> 753</li>
												<li><a href="#"><i class="icon-thumbs-down2 position-left"></i></a> 26</li>
											</ul>
										</div>
									</div>
								...
								<div class="panel panel-white">
									...
									<div id="question20" class="panel-collapse collapse">
										...
										<div class="panel-footer panel-footer-transparent">
											<ul>
												<li class="text-muted">Latest update: Mar 12, 2015</li>
											</ul>

											<ul class="pull-right">
												<li><a href="#"><i class="icon-thumbs-up2 position-left"></i></a> 589</li>
												<li><a href="#"><i class="icon-thumbs-down2 position-left"></i></a> 25</li>
											</ul>
										</div>
									</div>
						...
						<div class="col-lg-3">
							...
							<!--<div class="panel panel-flat">
								...
								<div class="panel-body">
									<ul class="media-list">
										<li class="media">
											<a href="#" class="media-left"><img src="assets/images/placeholder.jpg" class="img-circle" alt=""></a>
