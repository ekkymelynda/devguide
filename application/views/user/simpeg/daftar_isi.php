			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<div class="panel panel-white">
						<div class="panel-heading">
							<h3 class="panel-title">Sistem Informasi Kepegawaian</h3>
							<!--div class="heading-elements">
								<button type="button" class="btn btn-default btn-xs heading-btn"><i class="icon-file-check position-left"></i> Save</button>
								<button type="button" class="btn btn-default btn-xs heading-btn"><i class="icon-printer position-left"></i> Print</button>
		                	</div-->
								...
								<div class="row">
									<div class="col-md-12 content-group">
										...
										<h4>Daftar Isi</h4>
			 							<ul class="list-condensed list-unstyled">
			 								...
			 								<li><a href="<?php echo base_url(); ?>simpeg/halaman/<?php echo $row->ID_PST;?>"><?php echo $row->LINK_PST;?> <?php echo $row->JUDUL_PST;?></a></li>
			 								<?php }?>
									...
									<!--div class="col-md-6 content-group">
										<div class="invoice-details">
											<h5 class="text-uppercase text-semibold">Invoice #49029</h5>
											<ul class="list-condensed list-unstyled">
												<li>Pertanyaan/keluhan tentang: <br>Kelengkapan data/isian: <span class="text-semibold">Kontak BPS 031-5939632, 031-5994251-54, ext. 1292, 1111 </span></li>
												<li>Due date: <span class="text-semibold">May 12, 2015</span></li>
											</ul>
										</div>
									</div>-->
